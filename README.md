...
<table align="center" cellpadding="12" cellspacing="12" style="max-width:900px;width:100%;margin:auto;">
  <tr>
    ...
    <td valign="top" style="width:48%;border-radius:14px;padding:16px;background:rgba(255,255,255,0.02);box-shadow:0 8px 30px rgba(2,6,23,0.6);backdrop-filter: blur(8px);-webkit-backdrop-filter: blur(8px);">
      ...
      <p style="margin:0 0 12px 0;display:flex;align-items:center;gap:12px;">
        ...
        <span>
          <strong style="font-size:18px;color:#fff;">Ahanaf Shahriar Nafiz</strong><br/>
          <span style="color:#cfcfe2;font-size:13px;">Frontend Developer • AI Enthusiast</span>
        </span>
      </p>

      <p style="color:#d8d8e8;margin-top:6px;line-height:1.5;font-size:14px;">
        I design & build polished frontends with a focus on modern UX, performance and maintainable code. I also experiment with AI to automate workflows and improve developer productivity.
      </p>

      <p style="margin-top:12px;">
        <a href="https://github.com/fizeeeti0n" target="_blank" style="text-decoration:none;">
          <img src="https://img.shields.io/badge/GitHub-%2312100E.svg?style=for-the-badge&logo=github&logoColor=white" alt="github"/>
        </a>
        <a href="https://www.linkedin.com/in/fizeeeti0n" target="_blank" style="text-decoration:none;margin-left:8px;">
    ...
    <td valign="top" style="width:48%;border-radius:14px;padding:16px;background:linear-gradient(180deg, rgba(255,255,255,0.015), rgba(255,255,255,0.01));box-shadow:0 8px 30px rgba(2,6,23,0.6);backdrop-filter: blur(6px);-webkit-backdrop-filter: blur(6px);">
      <p style="margin:0 0 12px 0;">
        ...
        <span style="color:#cfcfe2;font-size:13px;">Recent coding activity, top languages and streaks</span>
      </p>
      ...
      <table cellpadding="6" cellspacing="0" style="margin-top:12px;border-radius:10px;background:linear-gradient(90deg, rgba(255,255,255,0.02), rgba(255,255,255,0.01));width:100%;">
        <tr>
          <td style="width:84px;padding:8px;">
            <img src="https://i.scdn.co/image/ab67616d00004851f0e3d6b5f8b3b0f7a4b2b8b7" alt="cover" width="64" height="64" style="border-radius:8px;"/>
          </td>
          <td style="vertical-align:middle;">
            <div style="font-weight:700;color:#fff;">Sample Track Title</div>
            <div style="color:#cfcfe2;font-size:13px;margin-top:4px;">Artist Name • Album</div>
          </td>
          <td style="text-align:right;vertical-align:middle;padding-right:12px;">
            <img src="https://img.shields.io/badge/Spotify-Now%20Playing-%231DB954?style=for-the-badge&logo=spotify" alt="spotify-badge" height="28"/>
          </td>
        </tr>
      </table>

      <p style="color:#bdbdd3;font-size:13px;margin-top:8px;">
        To enable real "now playing" cards you can:
        <ol style="margin:6px 0 0 18px;padding:0;color:#bdbdd3;">
          <li>Use a public Readme-now-playing service and paste the generated <code>img</code> URL here.</li>
          <li>Or self-host a small service that fetches your Spotify currently-playing via OAuth and exposes an SVG card (many examples exist on GitHub).</li>
        </ol>
      </p>
    </td>
  </tr>
  ...
  <tr>
    <td colspan="2" style="padding:0;">
      ...
      <p align="center" style="margin:14px 0 0 0;color:#cfcfe2;font-size:13px;">
        <img src="https://komarev.com/ghpvc/?username=fizeeeti0n&color=green" alt="profile views" style="vertical-align:middle;margin-right:8px;"/>
        Thanks for visiting — explore my repos & say hi! 🚀
      </p>
    </td>
  </tr>
</table>
